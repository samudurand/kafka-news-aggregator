...
object Decoders {
  ...
  implicit val toolDecoder: EntityDecoder[IO, Seq[ToolTweet]] = circe.jsonOf[IO, Seq[ToolTweet]]
...
object Encoders {
  ...
  implicit val toolEncoder: EntityEncoder[IO, Seq[ToolTweet]] = jsonEncoderOf[IO, Seq[ToolTweet]]
